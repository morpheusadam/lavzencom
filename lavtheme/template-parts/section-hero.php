<?php
/**
 * Home hero — headline, real search form (wired to the shop) and the department
 * marquee built from the live download_category terms.
 *
 * @package lavtheme
 */
...
/**
 * Build one marquee group of department chips with cycling size tiers.
 *
 * @param array $depts      Department rows.
 * @param bool  $decorative When true the chips are aria-hidden + untabbable.
 * @param int   $repeat     How many times to repeat the set (density).
 * @return string
 */
...
?>
<section class="hero" aria-label="<?php esc_attr_e( 'Search the LAVZEN marketplace', 'lavtheme' ); ?>">
  <div class="hero__bg" aria-hidden="true"></div>
  <div class="hero__grain" aria-hidden="true"></div>

  <div class="hero__inner">
    <div class="hero__copy">
      <p class="hero__eyebrow"><?php esc_html_e( 'The marketplace for everything AI', 'lavtheme' ); ?></p>
      <h1 class="hero__title"><?php esc_html_e( 'Everything AI', 'lavtheme' ); ?><br><?php esc_html_e( 'One search', 'lavtheme' ); ?></h1>
      <p class="hero__sub"><?php esc_html_e( 'Models, agents, datasets, hardware — and the', 'lavtheme' ); ?> <br class="brk-md"><?php esc_html_e( 'talent to ship them.', 'lavtheme' ); ?></p>
    </div>

    <form class="hero__search" role="search" action="<?php echo esc_url( lavtheme_shop_url() ); ?>" method="get">
      <label for="hero-q" class="sr-only"><?php esc_html_e( 'Search the marketplace', 'lavtheme' ); ?></label>
      <input id="hero-q" name="pq" class="hero__input" type="search" inputmode="search"
             placeholder="<?php esc_attr_e( 'Search anything in AI…', 'lavtheme' ); ?>" autocomplete="off" enterkeyhint="search" data-typewriter />
      <kbd class="hero__kbd" aria-hidden="true">/</kbd>
      <button class="hero__submit" type="submit" aria-label="<?php esc_attr_e( 'Search', 'lavtheme' ); ?>">
    ...
    <nav class="hero__cats" aria-label="<?php esc_attr_e( 'Browse categories', 'lavtheme' ); ?>">
      <div class="marquee" data-paused="false">
        ...
        <button class="marquee__toggle" type="button" aria-pressed="false" aria-label="<?php esc_attr_e( 'Pause moving categories', 'lavtheme' ); ?>"><svg class="icon-pause" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><rect x="7" y="6" width="3.4" height="12" rx="1.2"/><rect x="13.6" y="6" width="3.4" height="12" rx="1.2"/></svg><svg class="icon-play" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M8 5.5v13l11-6.5z"/></svg><span class="label-pause"><?php esc_html_e( 'Pause', 'lavtheme' ); ?></span><span class="label-play"><?php esc_html_e( 'Play', 'lavtheme' ); ?></span></button>
      </div>
    </nav>
  </div>
</section>
