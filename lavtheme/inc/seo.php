...
function lavtheme_seo_robots_txt( $output, $public ) {
	...
	// llms.txt pointer kept as a comment: "LLM:" is a non-standard directive that
	// robots.txt validators (and Lighthouse SEO) reject as unknown. The file is
	// still served at /llms.txt; advertising it as a comment keeps robots.txt valid.
