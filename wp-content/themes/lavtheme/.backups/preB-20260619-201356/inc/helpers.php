...
/**
 * Output a sanitised inline SVG string.
 *
 * @param string $svg Raw SVG markup.
 */
function lavtheme_svg( $svg ) {
	echo wp_kses( $svg, lavtheme_svg_allowed_html() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
}
