<?php
/**
 * Single-download template BODY — the editable product design.
 *
 * Loaded by single-download.php (a thin loader), or overridden live via
 * Code Studio -> "Single Download (template)" -> Template (PHP/HTML). This file
 * is the editor DEFAULT and the safe fallback. All data is real: native EDD +
 * lavtheme product meta (inc/edd-product-meta.php). Keep the getter calls intact.
 *
 * @package lavtheme
 */
